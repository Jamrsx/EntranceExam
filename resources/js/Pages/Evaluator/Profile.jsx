                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                ...
                                                <input
                                                    ...
                                                    className="pl-10 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm transition-colors duration-200 py-3"
                                            ...
                                            <div>
                                                ...
                                                <div className="relative">
                                                    ...
                                                    <input
                                                        ...
                                                        disabled
                                                        className="pl-10 block w-full border-gray-300 rounded-lg shadow-sm bg-gray-100 text-gray-500 sm:text-sm cursor-not-allowed py-3"
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="pt-6 border-t border-gray-200">
                                        <button
                                            type="button"
                                            onClick={handleEditToggle}
                                            className="w-full inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-lg shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200"
                                        >
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                ...
                                                <input
                                                    ...
                                                    className="pl-10 pr-10 block w-full border-gray-300 rounded-lg shadow-sm focus:ring-red-500 focus:border-red-500 sm:text-sm transition-colors duration-200 py-3"

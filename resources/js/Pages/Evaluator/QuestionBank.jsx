        ...
        <>
            ...
            <Layout user={user} routes={routes}>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    {/* Header Section */}
                    <div className="mb-6 bg-gradient-to-r from-green-600 to-teal-600 rounded-lg p-4 text-white animate-fadeIn">
                        <div className="flex items-center justify-between">
                                                    <div>
                            <h1 className="text-2xl font-bold">Question Bank</h1>
                            <p className="mt-1 text-green-100">Manage {evaluator?.Department || 'department'}-specific exam questions and templates</p>
                            <div className="mt-3 flex items-center space-x-4">
                                ...
                                <div className="flex items-center">
                                    ...
                                    <span className="text-sm">{categories?.length || 0} categories</span>
                                </div>
                            </div>
                        </div>
                        <div className="text-right">
                            <a
                                ...
                                className="bg-white bg-opacity-20 backdrop-blur-sm text-black px-4 py-2 rounded-lg hover:bg-opacity-30 transition-all duration-200 font-medium flex items-center gap-2 mb-2"
                            >
                    ...
                    <div className="bg-gradient-to-r from-green-50 to-teal-50 border border-green-200 rounded-lg p-4 mb-6 shadow-lg animate-fadeIn">
                        <div className="flex justify-between items-center">
                            <div className="flex items-center space-x-3">
                                ...
                                <div>
                                    <h2 className="text-lg font-semibold text-green-800">Templates & Upload</h2>
                                    <p className="text-sm text-green-600">Download {evaluator?.Department || 'department'}-specific templates and import questions</p>
                                </div>
                            </div>
                                        ...
                                        <div className="absolute top-full left-0 mt-1 bg-white rounded-lg shadow-lg border border-black p-3 w-64 z-50 backdrop-blur-sm">
                                            <div className="space-y-2">
                                                ...
                                                >
                                                    ...
                                                    <div>
                                                        <p className="font-medium text-gray-900">{evaluator?.Department || 'Department'} Excel Template</p>
                                                        <p className="text-sm text-gray-500">Download .xlsx format with {evaluator?.Department || 'department'}-specific sample data</p>
                                                    </div>
                                                </button>
                                            </div>
                                        </div>
                                        ...
                                        <div className="absolute top-full left-0 mt-1 bg-white rounded-lg shadow-lg border border-black p-3 w-64 z-50 backdrop-blur-sm">
                                            <div className="mb-3">
                                                <label className="block text-sm font-medium text-gray-700 mb-2">
                                                    Supported: Excel (.xlsx, .xls) only
                                                </label>
                                                <p className="text-xs text-gray-500 mb-3">
                                                    Questions will be imported to {evaluator?.Department || 'your department'} question bank
                                                </p>
                                                <p className="text-xs text-gray-500 mb-3">
                                                    Use the department-specific Excel template for best results
                                                </p>
                                                <p className="text-xs text-gray-500 mb-3">
                                                    Template includes: Question, Options 1-5, Correct Answer, Category, Direction
                                                </p>
                                                <input
                                                    type="file"
                                                    accept=".xlsx,.xls"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-3">
                            ...
                            <div className="flex flex-col space-y-1">
                                ...
                                <select
                                    ...
                                    className="border border-gray-300 rounded-md shadow-sm focus:ring-2 focus:ring-green-100 focus:border-green-500 transition-all duration-200 text-sm"
                                >
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex items-center space-x-2">
                                    <span className="text-sm text-gray-700">
                                        {questions?.data?.length || 0} of {questions?.total || 0} questions
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <>
                            ...
                            <div className="px-4 py-3 border-b border-gray-200 bg-gradient-to-r from-gray-50 to-white">
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="flex items-center space-x-2 bg-green-50 px-3 py-2 rounded-lg border border-green-200 relative">
                                        <input
                                            type="checkbox"
                                            checked={selectAll}
                                        ...
                                        />
                                        <span className="text-sm font-medium text-green-800">Select All</span>

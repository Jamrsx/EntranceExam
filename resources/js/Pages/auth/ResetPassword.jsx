                        ...
                        <div className="w-full lg:w-1/2 bg-gradient-to-br from-blue-600 via-blue-700 to-purple-800 relative overflow-hidden p-4 lg:p-6">
                            ...
                            <div className="relative z-10 flex items-center justify-center h-full">
                                <div className="text-center">
                                    ...
                                    <p className="text-blue-100 text-xs lg:text-sm mb-2 lg:mb-3">Reset Your Password</p>
                                ...
                                {showSuccess ? (
                                    ...
                                    <>
                                        <div className="text-center mb-4 lg:mb-6">
                                            <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 mb-2 lg:mb-3">Enter Reset Code</h1>
                                                    ...
                                                    <div className="flex items-center justify-center gap-2 sm:gap-3" role="group" aria-label="Reset code inputs">
                                                        {Array.from({ length: 6 }).map((_, idx) => (
                                                            <input
                                                                ...
                                                                className={`w-10 h-12 sm:w-12 sm:h-14 text-center text-lg sm:text-2xl font-semibold tracking-widest bg-white border-2 rounded-lg focus:outline-none focus:ring-4 focus:ring-blue-100 transition-all duration-200 shadow-sm ${errors.code ? 'border-red-500 focus:border-red-500' : 'border-gray-200 focus:border-blue-500'}`}
                                    ...
                                    <>
                                        <div className="text-center mb-4 lg:mb-6">
                                            ...
                                            <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 mb-2 lg:mb-3">Create New Password</h1>
                                            <p className="text-gray-600 text-sm">

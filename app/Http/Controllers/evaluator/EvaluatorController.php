...
class EvaluatorController extends Controller
{
    public function dashboard(Request $request)
    {
        ...
        $statsQuery = DB::table('examinee_recommendations as er')
        ...
        $statsQuery->where(function ($q) use ($department) {
        ...
        $totalStudents = $statsQuery->distinct('er.examinee_id')->count('er.examinee_id');

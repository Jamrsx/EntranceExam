...
class RecommendationRulesController extends Controller
{
    ...
    private function getComprehensivePersonalityProfiles()
    {
        return [
            ...
            'INFP' => [
                ...
                'strengths' => ['creativity', 'empathy', 'idealism', 'adaptability', 'authenticity', 'artistic expression', 'values focus', 'analysis', 'innovation'],
                'preferred_work' => ['writing', 'arts', 'counseling', 'education', 'creative work', 'music', 'therapy', 'technology', 'research', 'leadership'],
                'course_affinity' => ['arts', 'literature', 'psychology', 'education', 'humanities', 'philosophy', 'music', 'creative', 'technology', 'research', 'leadership'],
                'learning_style' => ['creative', 'values-based', 'expressive', 'meaningful', 'analytical', 'innovative'],
                'work_environment' => ['creative', 'authentic', 'meaningful', 'artistic', 'innovative'],
                'threshold' => 3 // Lowered for more inclusive matching
            ],
            'ENFJ' => [
            ...
            'ISFJ' => [
                ...
                'strengths' => ['loyalty', 'practicality', 'attention to detail', 'empathy', 'reliability', 'support', 'compassion', 'analysis', 'leadership'],
                'preferred_work' => ['healthcare', 'education', 'customer service', 'administration', 'counseling', 'nursing', 'technology', 'business', 'leadership'],
                'course_affinity' => ['nursing', 'healthcare', 'education', 'social work', 'counseling', 'administration', 'service', 'technology', 'business', 'leadership'],
                'learning_style' => ['practical', 'supportive', 'detail-focused', 'traditional', 'analytical', 'innovative'],
                'work_environment' => ['supportive', 'helpful', 'reliable', 'compassionate', 'innovative'],
                'threshold' => 3 // Lowered for more inclusive matching
            ],
            'ESTJ' => [
            ...
            'ESFJ' => [
                ...
                'strengths' => ['cooperation', 'practicality', 'sensitivity', 'loyalty', 'organization', 'support', 'sociability', 'leadership', 'innovation'],
                'preferred_work' => ['healthcare', 'education', 'customer service', 'event planning', 'counseling', 'nursing', 'technology', 'business', 'leadership'],
                'course_affinity' => ['nursing', 'healthcare', 'education', 'social work', 'communications', 'hospitality', 'service', 'technology', 'business', 'leadership'],
                'learning_style' => ['cooperative', 'practical', 'supportive', 'social', 'innovative', 'analytical'],
                'work_environment' => ['cooperative', 'supportive', 'social', 'helpful', 'innovative'],
                'threshold' => 3 // Lowered for more inclusive matching
            ],
            'ISTP' => [
    ...
    private function extractSemanticThemes($description)
    {
        ...
        // Enhanced theme keywords with comprehensive coverage
        $themeKeywords = [

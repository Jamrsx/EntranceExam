            ...
            while (($data = fgetcsv($handle, 0, $delimiter)) !== FALSE) {
                ...
                if (count($data) >= 7) {
                    ...
                    if (empty($questionData['question']) || 
                        ...
                        empty($questionData['option3']) || 
                        empty($questionData['option4']) || 
                    ...
                    // Validate correct answer (now supports A, B, C, D, E)
                    if (!in_array($questionData['correct_answer'], ['A', 'B', 'C', 'D', 'E'])) {
                        Log::warning('Skipping row ' . $rowNumber . ' due to invalid correct answer: ' . $questionData['correct_answer']);
                        continue;
                    }
